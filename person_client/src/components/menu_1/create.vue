		...
		<div :style="{width: width,margin: '0 20px',padding:'30px 20px'}">
			<a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol"
				...
				<a-form-model-item ref="tag" label="标签" prop="tag">
					<!-- <a-input v-model="form.tag" placeholder="可选至多 5 个标签，支持搜索" @blur="  () => { $refs.tag.onFieldBlur();} " /> -->
					<a-select mode="tags" v-model="tags" style="width: 100%" allowClear placeholder="可选至多 5 个标签，支持搜索" :maxTagCount="6"
				...
				<a-form-model-item :wrapper-col="wrapperCol1">
					<a-button type="primary" style="width:40%;min-width: 64px;" @click="onSubmit">
						提交
					</a-button>
